...
# Date: Aug 14, 2025
# Purpose: Extract and visualize temperatures from individual FLIR images


# 1. Set path to where we are keeping the FLIR images----
# for this example, we will use PA
img_path <- "../FLIR_Images/Sierra Nevada/Photos_Sierra_Nevada/Good"



# 2. Extract raw thermal data and metadata----
...
# 3. Convert raw data to temp data----
...
# 4. Compute temp and summary stats----
flir_stats <- map2(
  .x = flir_temp,
  .y = names(flir_temp),
...
# 7. Compare hobodata to flir data----
...
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
